/*
  Tuple(rinkinys) - tai masyvas su griežtai nurodytais masyvo elemento tipais ir jų seka.
...
console.group('Tuples - užduotys');
{
  ...
  {
    const person1: PersonTuple = ['Jonas', 23];
    const person2: PersonTuple = ['Algis', 65];
